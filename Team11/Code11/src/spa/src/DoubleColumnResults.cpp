...
//        cout << table1.table_to_string("s1") << table2.table_to_string("s1") << endl;
    std::clock_t start;
    double duration;
...
//                cout << "i" << e1.to_string() + " " + e2.to_string() + " " + ::to_string(table2.exists(syn1, syn2, e1, e2)) << endl;
