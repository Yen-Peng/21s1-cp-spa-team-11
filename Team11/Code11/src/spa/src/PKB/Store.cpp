...
bool Store::addIfStmtCV(int ifStmtNum, string var) {
    ifStmtsWithCVList->emplace(ifStmtNum);
    ifCVList->emplace(var);
...
bool Store::addWhileStmtCV(int whileStmtNum, string var) {
    whileStmtsWithCVList->emplace(whileStmtNum);
    whileCVList->emplace(var);
...
unordered_set<int>* Store::getAllIfStmtsWithCV() {
    return ifStmtsWithCVList;
}

unordered_set<string>* Store::getAllIfCV() {
    return ifCVList;
}
...
unordered_set<int>* Store::getAllWhileStmtsWithCV() {
    return whileStmtsWithCVList;
}

unordered_set<string>* Store::getAllWhileCV() {
    return whileCVList;
}
...
void Store::clear() {
    ...
    ifStmtsWithCVList->clear();
    ifCVList->clear();
    whileStmtsWithCVList->clear();
    whileCVList->clear();
    ifList->clear();
    ifBlockList->clear();
    elseBlockList->clear();
