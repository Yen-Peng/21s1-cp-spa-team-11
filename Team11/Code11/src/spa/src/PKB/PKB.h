...
public:
    ...
    // get all if condition statements with control variables present
    UNORDERED_LIST_OF_INT *getAllIfStmtsWithCV();

    // get list of all control variables present in if condition statements
    ...
    // get list of all if condition statements that have control variables
    UNORDERED_LIST_OF_INT *getAllWhileStmtsWithCV();

    // get list of all control variables present in while condition statements
