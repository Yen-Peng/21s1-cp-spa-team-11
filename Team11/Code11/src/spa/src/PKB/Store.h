...
private:
    ...
    UNORDERED_LIST_OF_INT *ifStmtsWithCVList;
    UNORDERED_LIST_OF_INT *whileStmtsWithCVList;
    UNORDERED_LIST_OF_STR *ifCVList;
    UNORDERED_LIST_OF_STR *whileCVList;
...
public:
    Store() {
        ...
        ifStmtsWithCVList = new unordered_set<int>();
        whileStmtsWithCVList = new unordered_set<int>();
        ifCVList = new unordered_set<string>();
        whileCVList = new unordered_set<string>();
    ...
    UNORDERED_LIST_OF_INT *getAllIfStmtsWithCV();

    UNORDERED_LIST_OF_STR *getAllIfCV();

    UNORDERED_LIST_OF_INT getWhileStmtsWithCV(string var);

    UNORDERED_LIST_OF_STR getAllCVInWhileStmt(int stmtNum);

    UNORDERED_LIST_OF_INT *getAllWhileStmtsWithCV();

    UNORDERED_LIST_OF_STR *getAllWhileCV();
