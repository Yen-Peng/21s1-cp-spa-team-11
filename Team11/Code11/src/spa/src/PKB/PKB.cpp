...
UNORDERED_LIST_OF_INT *PKB::getAllIfStmtsWithCV() {
    return store.getAllIfStmtsWithCV();
}

unordered_set<string>* PKB::getAllIfCV() {
    return store.getAllIfCV();
}
...
UNORDERED_LIST_OF_INT *PKB::getAllWhileStmtsWithCV() {
    return store.getAllWhileStmtsWithCV();
}

unordered_set<string>* PKB::getAllWhileCV() {
    return store.getAllWhileCV();
}
...
LIST_OF_INT_PAIRS PKB::getNextBipNN(int stmt1, int stmt2) {
    if (store.getNextBipNN(stmt1, stmt2).size() == 0) {
