...
bool Query::addSuchThat(QueryClause::relationshipType rType, string arg1, QueryClause::suchThatFlag flag1,
    ...
    cout << "adding: " << QueryClause(QueryClause::suchThat(rType, arg1, flag1, arg2, flag2)).to_string();
...
bool Query::addPattern(string stmt_synonym, string lhs, QueryClause::patternFlag leftFlag, string rhs,
    ...
    cout << "adding: " << QueryClause(QueryClause::pattern(stmt_synonym, lhs,rhs, leftFlag, rightFlag)).to_string();
...
//    Query::instance = new Query();
    cout << "resetting Query." << "\n";
    isValidQuery = true;
    _isSemanticError = false;
    _isSyntaxError = false;
    declarations.clear();
    //declarations = unordered_map<std::string, entityType>();
