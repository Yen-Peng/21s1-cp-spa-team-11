...
public:
    ...
    // TODO: bad implementation try not to use
    template<class T>
    ...
    // TODO: notes - O(n^2)/O(mn) operation, has the assumption that group1 and group2 are correct cross products
    template<class T>
    static CrossProductStruct<T> crossProduct(CrossProductStruct<T> group1, CrossProductStruct<T> group2) {
        ...
        cout << "crossing: <";
        for (auto s : group1.header) {
            cout << s << ", ";
        }
        cout << "> and <";
        for (auto s : group2.header) {
            cout << s << ", ";
        }
        cout << ">" << endl;
