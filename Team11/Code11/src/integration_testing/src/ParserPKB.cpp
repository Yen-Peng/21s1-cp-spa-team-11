...
TEST_CASE("Parser-PKB Test") {
    ...
    SECTION("Get control variables") {
        ...
        SECTION("getAllIfStmtsWithCV"){
            unordered_set<int> expected = {3};
            REQUIRE(*(pkb.getAllIfStmtsWithCV()) == expected);
        }
        SECTION("getAllIfCV"){
            unordered_set<string> expected = {"c","k"};
            REQUIRE(*(pkb.getAllIfCV()) == expected);
        }
        ...
        SECTION("getAllWhileStmtsWithCV"){
            unordered_set<int> expected = {5};
            REQUIRE(*(pkb.getAllWhileStmtsWithCV()) == expected);
        }
        SECTION("getAllWhileCV"){
            unordered_set<string> expected = {"w"};
            REQUIRE(*(pkb.getAllWhileCV()) == expected);
        }
    }
    SECTION("Get Follows") {
